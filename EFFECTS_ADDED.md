# Effects catalog & removable list
...
| id | HUD | Origin (short) |
| --- | --- | --- |
| 0 | `flock` | Mandala flowers — mrange **CC0** |
| 1 | `truchet` | Idea-only Holi Truchet (not 7lKSWW) |
| 2 | `starnest` | Star Nest — Kali **MIT** |
| 3 | `golden` | Golden apollian — mrange **CC0** (adapted) |
| 4 | `logspiral` | Log spiral — mrange **CC0** (adapted) |
| 5 | `apollo` | Apollian with a twist — mrange **CC0** |
| 6 | `eel` | Electric Eel — mrange **CC0** |
